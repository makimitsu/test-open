function [N_projection, N_grid3d, gm3d,U3d,s3d, v3d, M3d, K3d, nolines] = parametercheck_3d(newProjectionNumber, newGridNumber)
...
if isfile(parameterFile)
        ...
        load(parameterFile,'N_projection','N_grid3d','gm3d','U3d','s3d','v3d','M3d','K3d','nolines');
