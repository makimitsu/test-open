...
if strcmp(plotType,'TF_group')||strcmp(plotType,'GFR_group')
    ...
    for i = 1:n_data
        ...
        for j = 1:4
            ...
            Imax_tmp = max(downstreamList(i).max_r(j,3));
            Imean_tmp = max(downstreamList(i).mean_r(j,3));
...
if plotMax
    I_plot = Imax;
    label_y = 'max intensity in downstream region';
else
    I_plot = Imean;
    label_y = 'mean intensity in downstream region';
end
