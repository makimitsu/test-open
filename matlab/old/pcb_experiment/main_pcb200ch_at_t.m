...
for i=1:n_data
    ...
    i_EF=EFlist;
    TF=TFlist;
    plot_psi200ch(time, date, dtacq_num, shot, tfshot, pathname,n,i_EF,trange,TF,cmap);
end
...
function plot_psi200ch(time, date, dtacq_num, shot, tfshot, pathname, n,i_EF,trange,TF,cmap)
