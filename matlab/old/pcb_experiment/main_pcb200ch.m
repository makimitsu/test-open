...
for i=1:n_data
    ...
    i_EF=EFlist;
    TF=TFlist;
    plot_psi200ch(date, dtacq_num, shot, tfshot, pathname,n,i_EF,trange,TF,cmap);
end
...
function plot_psi200ch(date, dtacq_num, shot, tfshot, pathname, n,i_EF,trange,TF,cmap)
Nplot = 4;%【input】プロット枚数(16以下の4の倍数or3以下)
start = 476;%【input】プロット開始時間
dt = 2;%【input】プロット時間間隔
