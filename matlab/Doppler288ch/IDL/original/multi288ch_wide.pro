...
z=read_ascii("G:\My Drive\OnoLab\idl\doppler_practice2\z_negative.txt") & z=reform(z.field1)*1.e-3
p=read_Ascii("G:\My Drive\OnoLab\idl\doppler_practice2\r.txt") & p=p.field1*1.e-3
...
calib=read_ascii("G:\My Drive\OnoLab\idl\doppler_practice2\Ar_calibration.0916_remake.txt",data_start=1) & calib=calib.field1
ch=reform(calib[0,*])
