...
z=read_ascii("\\Mac\Home\Documents\lab\0_Doctor\TS-6\2223\matlab\Doppler288ch\edited\z_negative.txt") & z=reform(z.field1)*1.e-3
p=read_Ascii("\\Mac\Home\Documents\lab\0_Doctor\TS-6\2223\matlab\Doppler288ch\edited\r.txt") & p=p.field1*1.e-3
edge=0.33     ; 2022/7　解析～　ポテンシャルの範囲より仮定
filename=dialog_pickfile(path="X:\results\Doppler\Andor\320CH\20210924",filter="*.asc")
...
bg=read_Ascii("X:\results\Doppler\Andor\320CH\20210916\bg.asc") & bg=transpose(bg.field0001(1:*,0:*)) & D=D-Bg
calib=read_ascii("\\Mac\Home\Documents\lab\0_Doctor\TS-6\2223\matlab\Doppler288ch\edited\Ar_calibration.0916_remake.txt",data_start=1) & calib=calib.field1
ch=reform(calib[0,*])
...
contour,Ti_2D/tmax,yy,z,/fill,nlevels=256,xst=1,yst=1,zst=1,/isotropic,zr=[0,2],xr=[min(p),max(p)]
loadct,1 
